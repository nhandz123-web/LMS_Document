            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.documents.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- Thêm vào form trong create.blade.php --}}
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text text-danger">
                                <i class="fas fa-exclamation-circle"></i> Chưa có danh mục nào. Vui lòng thêm danh mục vào Database trước.
                            </div>
                            @endif
                        </div>
